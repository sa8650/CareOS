...
INSERT OR IGNORE INTO admins (name, email, password_hash, role) VALUES ('Admin', 'admin@clinic.com', '240be518fabd2724ddb6f04eeb1da5967448d7e831c08c8fa822809f74c720a9', 'admin');
...
/* SEO defaults are generated automatically from the doctor profile.
   Optional site-wide SEO settings (Admin -> SEO Settings). Leave seo_site_url empty to use the current domain. */
INSERT OR IGNORE INTO settings (key, value) VALUES ('seo_location', '');

INSERT OR IGNORE INTO settings (key, value) VALUES ('seo_site_url', '');
