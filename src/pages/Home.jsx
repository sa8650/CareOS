...
import { ArrowRight, Award, Users, Star, Shield, Phone, MapPin, Clock, ChevronRight, Calendar, Building2 } from 'lucide-react';
...
export default function Home() {
  ...
  return (
    <>
          ...
          <div className="hero-image">
            <div className="hero-img-wrapper">
              ...
              {doctor?.profile_image ? (
                <img src={`/api/image?key=${encodeURIComponent(doctor.profile_image)}`} alt={doctor.name} className="hero-doctor-photo" />
              ) : (
      ...
      <section className="section">
        <div className="container about-preview">
          <div className="about-preview-img">
            {doctor?.profile_image ? (
              <img src={`/api/image?key=${encodeURIComponent(doctor.profile_image)}`} alt={doctor.name} className="about-doctor-photo" />
            ) : (
          ...
          <div className="about-preview-content">
            ...
            <p>{doctor?.bio || 'With over 15 years of experience in dermatology, I combine medical expertise with a compassionate approach.'}</p>
      ...
      {/* Conditions We Treat - HTML Style */}
      ...
      <style>{`
        /* Hero - Your Original Animated Style */
        ...
        .hero-doctor-photo { width: 100%; aspect-ratio: 4/5; object-fit: cover; border-radius: 2rem; position: relative; z-index: 1; animation: heroImg 1s ease forwards; }
        @keyframes heroImg { from { opacity: 0; transform: scale(0.9); } to { opacity: 1; transform: scale(1); } }
        .hero-img-placeholder { width: 100%; aspect-ratio: 4/5; background: linear-gradient(135deg, var(--color-primary), var(--color-accent)); border-radius: 2rem; display: flex; align-items: center; justify-content: center; position: relative; z-index: 1; }
        ...
        .hero-float-card-1 { bottom: 20%; left: -20px; }
        ...
        .section-label { display: inline-flex; align-items: center; gap: 0.375rem; color: var(--color-primary); font-weight: 600; font-size: 0.85rem; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 0.5rem; }
        ...
        /* Conditions We Treat - HTML Card Style */
        ...
        .condition-card:hover { transform: translateY(-4px); background: rgba(255,255,255,0.7); box-shadow: 0 12px 32px rgba(0,0,0,0.08); }
        ...
        .condition-card h3 { font-size: 1.05rem; font-weight: 700; margin-bottom: 0.75rem; color: var(--color-text); }
        .condition-list { list-style: none; margin-bottom: 1rem; }
        .condition-list li {
          font-size: 0.85rem; color: var(--color-text-body); padding: 0.375rem 0;
