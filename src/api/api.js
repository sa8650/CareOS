...
export const fetchSections = () => request('/sections');
...
export const adminSections = () => adminGet('/sections');
export const adminCreateSection = (data) => adminPost('/sections', data);
export const adminUpdateSection = (id, data) => adminPut(`/sections/${id}`, data);
export const adminDeleteSection = (id) => adminDelete(`/sections/${id}`);
