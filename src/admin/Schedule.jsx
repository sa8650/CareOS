  ...
  return (
    <div>
      ...
      <style>{`
        ...
        @media (max-width: 420px) { .sch-stats { grid-template-columns: repeat(2, minmax(0, 1fr)); } }
        ...
        @media (max-width: 768px) {
          ...
          .sch-header { flex-direction: column; align-items: stretch; margin-bottom: 1rem; }
          .sch-controls { width: 100%; }
          .sch-chamber-select { flex: 1; min-width: 0; }
          .sch-chamber-select .form-select { min-width: 0; width: 100%; }
          .sch-stats { grid-template-columns: repeat(3, minmax(0, 1fr)); gap: 0.5rem; }
