...
export default function Chambers() {
  ...
  // /admin/chambers?new=1 (dashboard quick action) opens the existing Add modal once
  ...
  return (
    <div>
      ...
      <style>{`
        ...
        .chamber-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(min(300px, 100%), 1fr)); gap: 1rem; }
