...
/* Admin-managed "featured" sections shown on the Home page after About Me
   (e.g. "Hair PRP", "Cosmetic and Laser Treatments"). Up to 3 images each. */
...
/* Per-page SEO overrides (Admin -> SEO Settings). Empty/missing = automatic defaults
   generated from the doctor profile. Keys: "home", "about", "service:<slug>", ... */
